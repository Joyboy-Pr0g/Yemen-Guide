...
import { Loader2, Upload, Mail, Globe, FileText, Sliders, Settings, Image as ImageIcon, Save, Video } from 'lucide-react'
import { useAdminSettings, useUpdateSettings, useUploadLogo } from '@/hooks/use-admin'
import { getImageUrl } from '@/lib/utils'
import Image from 'next/image'
import { useSettings } from '@/context/settings-context'
import { SiteSettings } from '@/types'
import AdminVisualsTab from '@/components/admin/settings/AdminVisualsTab'
...
type SettingsTab = 'general' | 'visuals'
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      <div className="flex items-center gap-3 border-b border-gray-100 pb-5">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">إدارة البيانات العامة والفيديوهات الإرشادية</p>
        </div>
      </div>
